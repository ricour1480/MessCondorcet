            ...
            .done(function(msg){
               if(Array.isArray(msg)){
                ...
                for(var i= 0;i<Panier.length-1;i++){
                    panier+="<li id='"+Panier[i][0]+"'><img src='./admin/images/delete.jpg'  class='img-fluid dustbin'   id='supprime"+Panier[i][0]+"' width= 25px alt='dustbin'/><span class='nomproduit"+Panier[i][0]+"'>"+Panier[i][1]+" </span>"+
