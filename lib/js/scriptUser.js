...
$(document).ready(function(){
   ...
   $("#AddPanier").click(function(){
       if($('#quantiteUser').val() > 0){
            ...
            .done(function(msg){
                var bouton="<input type='button' class='btn btn-info' name='commandeUser' id='commandeUser' value='Commander'/>";
