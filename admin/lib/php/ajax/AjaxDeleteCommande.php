...
try{
   ...
   $tab = $commande->AffichageCommandeQte($userid, $idproduit);
   $quantiteCom=$tab[0]['qte'];
   $commande->DeleteCommande($userid, $idproduit);
   
   $ajoutpanier->UpdateStockMin($idproduit,$stock+$quantiteCom);
